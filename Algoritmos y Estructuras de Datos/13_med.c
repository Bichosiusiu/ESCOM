...
int main() {
    ...
    burbuja(&queue);
    imprimir(&queue);
    printf("\nLa mediana de la cola es: %.2f",med(&queue));
     printf("\nIngrese 1 elementos en la cola:\n");
        scanf("%d", &n);
        enqueue(&queue,n);
    printf("\nElementos ordenados : ");
    burbuja(&queue);
    ...
    printf("\nLa mediana de la cola es: %.2f",med(&queue)-1);
